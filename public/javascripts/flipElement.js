(function() {
    ...
    var app = angular.module('flip-element', []);

    app.directive('flipType', function() {
        return {
            restrict: 'A',
            link: function($scope, ele, attr) {
                ele.bind('click', function(e) {
                    var element;
                    if (attr.flipType === "trigger") {
                        var el = $(ele).closest(".flip-elemt");
                        openModal(el);
                    }
                });
            }
    ...
    app.directive('flipForm', function() {
        return {
            restrict: 'A',
            link: function($scope, ele, attr) {
                if (attr.flipForm === "invisible") {
    ...
    this.getStyleObject = function(ele) {
        var dom = ele[0];
        var style;
        var returns = {};
